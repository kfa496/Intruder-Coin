...
contract ('IntruderSale',function(accounts){
	var tokenInstance;
	...
	return IntruderSale.deployed().then(function(instance) {
...
// 			//End Sale as admin
			...
			assert.equal(balance.toNumber(),999990, 'returns all unsold Intruder Tokens to admin');
			return tokenInstance.balanceOf(tokenSaleInstance.address);
		}).then(function(balance){
